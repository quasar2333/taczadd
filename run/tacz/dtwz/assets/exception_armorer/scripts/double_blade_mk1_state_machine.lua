...
function gun_kick_state.transition(this, context, input)
    if (input == INPUT_SHOOT) then
        ...
        if (gun_kick_state.melee_count == 0) then
            context:runAnimation("melee_1", track, true, PLAY_ONCE_STOP, 0.1)
            gun_kick_state.melee_count = gun_kick_state.melee_count + 1
        elseif (gun_kick_state.melee_count == 1) then
            context:runAnimation("melee_2", track, true, PLAY_ONCE_STOP, 0.1)
            gun_kick_state.melee_count = gun_kick_state.melee_count + 1
        elseif (gun_kick_state.melee_count == 2) then
            context:runAnimation("melee_3", track, true, PLAY_ONCE_STOP, 0.1)
            gun_kick_state.melee_count = gun_kick_state.melee_count + 1
        elseif (gun_kick_state.melee_count == 3) then
            context:runAnimation("melee_4", track, true, PLAY_ONCE_STOP, 0.1)
            gun_kick_state.melee_count = gun_kick_state.melee_count + 1
        elseif (gun_kick_state.melee_count == 4) then
            context:runAnimation("melee_5", track, true, PLAY_ONCE_STOP, 0.1)
            gun_kick_state.melee_count = 0
